                    ...
                    <View style={{ padding: 10 }}>
                        ...
                        <View>
                            ...
                            <View style={{paddingTop: 30}}>
                                <TouchableOpacity onPress={handletRegister} style={tw`items-center bg-purple-700 p-4 rounded-lg justify-center`}>
                                    <Text style={[styles.enter, tw`text-white font-bold`]}>Registar</Text>
                                </TouchableOpacity>
                            </View>
                            )}
                        </View>
                        ...
                        <View style={[tw`flex-row justify-center`, {paddingTop: 20}]}>
                            <Text style={[tw`font-semibold text-neutral-500`, {fontSize: moderateScale(12)}]}>Já possui uma conta ainda? </Text>
                            <Pressable onPress={() => router.push('signIn')}>
                                <Text style={[tw`font-semibold text-purple-700`, {fontSize: moderateScale(12)}]}>Entre aqui</Text>
                            </Pressable>
                        </View>
