                ...
                <View style={{ paddingTop: moderateScale(50), alignItems: 'center', flex: 1 }}>
                    ...
                    <View style={{ padding: 10 }}>
                        ...
                        <View style={[tw`flex-row justify-center`, {paddingTop: 20}]}>
                            <Text style={[tw`font-semibold text-neutral-500`, {fontSize: moderateScale(12)}]}>Não tem conta ainda? </Text>
                            <Pressable onPress={() => router.push('signUp')}>
                                <Text style={[tw`font-semibold text-purple-700`, {fontSize: moderateScale(12)}]}>Criar conta</Text>
                            </Pressable>
                        </View>
